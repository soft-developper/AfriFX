...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:  'bg-[#378ADD] text-white hover:bg-[#2a6fc4] active:scale-[0.98]',
        outline:  'border border-[#1B2B4B] bg-transparent hover:bg-[#0F1729] text-[#E2E8F0]',
        ghost:    'bg-transparent hover:bg-[#0F1729] text-[#E2E8F0]',
